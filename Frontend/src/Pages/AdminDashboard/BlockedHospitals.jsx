...
const BlockedHospitals = () => {
    ...
    const [selectedHospital, setSelectedHospital] = useState(null);
      ...
      try {
        const res = await fetch(`${BACKEND_URL}/admin/blocked_hospitals`, { method: "GET", credentials: "include" });
 ...
 useEffect(() => {
  ...
  String(hospital.verified_at || "").includes(searchQuery)
);
...
<p><b>Reason :</b>{selectedHospital.block_reason}</p>
...
export default BlockedHospitals;